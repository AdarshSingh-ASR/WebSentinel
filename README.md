# AI Website Testing Agent Platform - Powered by Portia AI
[Demo](https://www.loom.com/share/072926be9dc347859a4cab17928bcbd2?sid=cb29978d-0a60-4327-ade2-ea2fb6b67cd6)

🏆 **Built for AgentHack 2025** - Leveraging Portia AI's powerful agent framework

A powerful web-based platform for automated website testing that combines browser automation with AI analysis. This system features a **FastAPI backend** with **React frontend** providing real-time execution monitoring and comprehensive results visualization, now powered by **Portia AI**'s controllable agent framework.
...
- **Agent Intelligence**: **Portia AI** framework for structured planning and controllable agent execution
- **Real-time Monitoring**: Live status updates and execution progress tracking

## ✨ **Key Features**

- 🤖 **Portia AI-Powered Agents**: Structured, controllable agents with transparent planning and execution
- 🗣️ **AI Agent Reasoning**: Real-time capture of agent thoughts and decision-making processes
...
- 🛡️ **Controllable Execution**: Portia's steerable agent framework ensures predictable behavior
...
2. **Backend Setup**:
   ...
   pip install portia-sdk-python[google] browser-use python-dotenv fastapi uvicorn
...
This platform combines the power of modern web development with **Portia AI's controllable agent framework** to create an intuitive, comprehensive testing solution.

**Built for AgentHack 2025** - Demonstrating Portia AI's capabilities in real-world browser automation and testing scenarios.
